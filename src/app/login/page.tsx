      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-700 py-3 px-4 rounded-xl hover:bg-slate-50 transition-colors disabled:opacity-50 shadow-sm"
          >
